...
qasm_fp = Path("/home/lty/workbench/quantum_compilation/quantum-chip-network/tests/benchmark/Bench/Dis_Bench/zcz/multiplier_n50/multiplier_n50.qasm")
qasm_file = open(qasm_fp,"w")
